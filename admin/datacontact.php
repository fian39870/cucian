...
<div class="grid-container">
	...
	<div class="container">
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="datacontacttambah.php" method="post">
						...
						<div class="form-group">
           				<input type="textarea" class="form-control" name="message" placeholder="Message" required="required">
        				</div>    
		...
		<a href="datacontact.php" role="button" class="btn btn-primary btn-tambah" data-toggle="modal" data-target="#modalTambahData" style="margin:10px; float: right;">Tambah Data</a>
		<table class="table">
			...
			$collection_datapaket = $db->contact;
				...
				$result = $collection_datapaket->find(array('name' => new \MongoDB\BSON\Regex($_POST["cari"])));
				}else{
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="datacontactedit.php?id=<?php echo $hasil['_id']; ?>" role="button" class="btn btn-success">Edit</a>
